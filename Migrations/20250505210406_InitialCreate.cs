        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WhitelistedItems_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WhitelistedItems_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("9f3b53b8-13e9-4c66-b45e-6c56d0b0d6db"), "2829a150-9dd1-4617-9e4c-76f2341a5248", "Admin", "ADMIN" },
                    { new Guid("a87642e3-e4cd-45f4-8c6d-1a1f5f6c6709"), "bd65241f-f29c-4690-9a0a-2e556a9ceeb5", "Staff", "STAFF" },
                    { new Guid("b8fd98e7-3a5b-4275-b4bb-8c7ccda0d6b0"), "9135c6d1-5df1-4650-868e-c614b0d727f4", "Member", "MEMBER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WhitelistedItems_BookId",
                table: "WhitelistedItems",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_WhitelistedItems_UserId",
                table: "WhitelistedItems",
                column: "UserId");
        }
