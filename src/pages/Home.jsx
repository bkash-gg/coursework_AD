            ...
            {[ 
              {
                ...
                icon: (
                  <FaCamera className="text-4xl mb-2 mx-auto text-pink-500" />
                ),
              },
              {
                name: "Food & Drink",
                icon: (
                  <FaUtensils className="text-4xl mb-2 mx-auto text-yellow-500" />
                ),
              },
              {
                name: "Romance",
                icon: (
                  <FaHeart className="text-4xl mb-2 mx-auto text-red-500" />
                ),
              },
              {
                name: "Health",
                icon: (
                  <FaHeartbeat className="text-4xl mb-2 mx-auto text-green-500" />
                ),
              },
              {
                name: "Biography",
                icon: (
                  <FaBook className="text-4xl mb-2 mx-auto text-blue-500" />
                ),
              },
            ].map((category, idx) => (
              <div
              ...
              >
                ...
                <div className="absolute inset-0 rounded-full bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <p className="text-white font-semibold text-center">
                    Jane Smith
                    <br />
                    <span className="text-sm">Bestselling Author</span>
                  </p>
                </div>
              </div>
            ))}
